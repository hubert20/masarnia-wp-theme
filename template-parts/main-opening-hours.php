...
$test = get_field('test');
?>
<section class="opening-hours py-4 py-lg-5" <?php /*style="background-image: url('<?php echo $test; ?>');"*/ ?> id="opening-hours">
    <div class="container">
        <h2 class="text-center standard-title-3 mb-0">
            <span class="mea-culpa-font">Godziny otwarcia sklepów</span><br>
