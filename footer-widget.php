    ...
    <div class="container py-4 py-lg-5">
        <div class="row">
            <div class="col-lg-3 text-center">
                <h5 class="text-white standard-title-6 oswald-font mb-4">Bądź na bieżąco:</h5>
                <p class="standard-title-4">
                    <a href="https://www.facebook.com/Staropolska-Masarnia-131363080733228" title="facebook Staropolska Masarnia" target="_blank" class="text-white">
                        <i class="fa fa-facebook" aria-hidden="true"></i>
                    </a>
                </p>
            </div>
            <div class="col-lg-1 d-none d-lg-flex align-items-center justify-content-center">
                <div class="footer-widgets__space-border"></div>
            </div>
            <div class="col-lg-3 text-center">
            ...
            <div class="col-lg-3 text-center">
                <h5 class="text-white standard-title-6 oswald-font mb-4">Kontakt:</h5>
                <p class="text-gray">
                    <strong>Staropolska Masarnia Sp. z o.o.</strong><br>
                    ul. Brzozowa 1<br>
                    09-500 Gostynin<br>
                    NIP: 7743222411<br>
                    REGON: 360491973
...
<div class="container py-4">
    <p class="text-center text-gray mb-0"><small>Staropolska Masarnia Copyright 2009-2022</small></p>
</div>