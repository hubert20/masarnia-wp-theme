	...
	<div class="container pt-5 pb-5">
		<div class="row align-items-center">
			...
			<div class="col-lg-6">
				...
				<p>
					Serwis www  jest chwilowo niedostępny. Pracujemy nad naszymi serwerami, żeby jak najszybciej do Was wrócić. Dziękujemy za cierpliwość.
				</p>
				<p class="mb-4">
					A tymczasem możesz dowiedzieć się więcej o Akademii Przyszłości:
				</p>

				<a href="" class="btn btn-red btn-lg">Przejdź na www.pl ></a>
			</div>
		</div>
	</div>
</main><!-- #main -->
